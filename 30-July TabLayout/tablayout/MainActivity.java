...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUpPager(viewPager);//custom method-->fragement attach with activity
        tabLayout.setupWithViewPager(viewPager);//tab attach pager for swipe
    ...
    void setUpPager(ViewPager viewPager){
        ...
        pagerFunctionality.add(new CallFragment());
        //pagerFunctionality.add(new ContactFrament());
